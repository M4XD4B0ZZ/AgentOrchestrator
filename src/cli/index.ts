...
const DESCRIPTION = [
  ...
  '    does not suppress',
  '  - `delivery --publish-head --attended` starts Git twice: once to read one',
  '    ref on the delivery remote, and — only if that ref is absent — once to',
  '    create it at one commit. Git authenticates with the credential helper the',
