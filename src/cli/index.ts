...
const DESCRIPTION = [
  ...
  'the removal runs. So one narrow case stays outside this tool: a run that died',
  'between claiming the lease name and writing the record leaves an artefact with',
  'no legible owner, and nothing here can clear it.',
  '',
