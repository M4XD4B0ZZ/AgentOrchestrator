...
const DESCRIPTION = [
  ...
  '    reset any enlisted repository has durably recorded, and then plans again',
  ...
  'in this build, narrowly, and it is three separate things.',
  '',
  ...
  'schedules only what a task’s own durable state already says. Between passes it',
  ...
  '`repositories --attended`, waits for nothing but a recorded reset, and a quota',
  'block that records NO reset time is never waited for and stays the operator’s.',
  'It is not a daemon, not a cron and not a job queue: there is no recurring job,',
  'no schedule anyone can author and no notification.',
  '',
