...
const DESCRIPTION = [
  ...
  '    and `lease break --attended` to recover from one whose owner died',
  '',
  ...
  'decision — `lease break` requires --attended and the revision of the lease you',
  'inspected, removes exactly that lease and nothing else, and has no --force.',
  '',
